...
// Keep picker callers compatible without adding image preloading to the global
// emoji initialization path. Picker-specific lazy loading is handled inside the
// picker itself so post custom emoji rendering stays on Mastodon's normal path.
export function waitForCustomEmojiImages(): Promise<void> {

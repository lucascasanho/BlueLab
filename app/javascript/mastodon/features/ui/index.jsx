      ...
      <ColumnsContextProvider multiColumn={!singleColumn}>
        <ColumnsArea ref={this.setRef} singleColumn={singleColumn} domain={domain} minimalShell={minimalShell}>
          <WrappedSwitch forceCompactLayout={forceCompactLayout}>
            ...
            <WrappedRoute path='/conversations/:id' exact component={MessageConversation} content={children} />
            ...
            <WrappedRoute path='/scheduled' component={ScheduledPublications} content={children} />

...
interface InitialStateMeta {
  access_token: string;
  account_switcher_session_id?: string;
  ...
  hide_status_character_counter?: boolean;
...
export const hideStatusCharacterCounter =
  getMeta('hide_status_character_counter') ?? false;
...
export function getAccountSwitcherSessionId(): string | undefined {
  return getMeta('account_switcher_session_id');
}
